...
public class AuthUserDetail implements UserDetails { ///UserDetails do Spring -metodo
    ...
    @Override
    public Collection<? extends GrantedAuthority> getAuthorities() { //papel do usuário
