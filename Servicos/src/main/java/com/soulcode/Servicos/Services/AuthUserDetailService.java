...
@Service
public class AuthUserDetailService implements UserDetailsService { // método do SPRING
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (user.isEmpty()){
            throw new UsernameNotFoundException("Usuário não encontrado"); //EXECESSÃO DO SPRING
        }
